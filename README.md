...
## TODO
 ...
 2. If you see a warning (Incorrect format parameter) while importing Database dump mediawiki.2019-04-01_0315.gz on phpMyAdmin
   - Solution 1: Go to docker using ./bash command and update the php.ini file
      - upload_max_filesize=128M
      - post_max_size=128M
   - Solution 2: If the Solution 1 above doesn't help, do the import manually
